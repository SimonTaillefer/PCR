  ...
  <body>
    <div class="container">
      ...
      <div id="contenu">
        ...
        <p>PCR a été développée donc l'optique d'être un outil de collaboration qui permet à des chercheurs de pouvoir mener à bien leurs projets en apportant:</p>
        <ul>
          <li>une plateforme simple d'utilisation</li>
